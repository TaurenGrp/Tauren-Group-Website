...
class CarriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post carriers_url, params: { carrier: { country: @carrier.country, name: @carrier.name } }
    end
  ...
  test "should update carrier" do
    patch carrier_url(@carrier), params: { carrier: { country: @carrier.country, name: @carrier.name } }
